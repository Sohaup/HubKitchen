...
use PostApi\modules\CS\app\controllers\RoleController;
...
$listRoute = new Route(Urls::transformRouteUrl("/jobRoles/"), HttpMethodsType::GET, RoleController::class, 'index');
...
$createRoute = new Route(Urls::transformRouteUrl("/jobRoles/create"), HttpMethodsType::POST, RoleController::class, 'create');
...
$getRoute = new Route(Urls::transformRouteUrl("/jobRoles/:id"), HttpMethodsType::GET, RoleController::class, 'get');
...
$updateRoute = new Route(Urls::transformRouteUrl("/jobRoles/:id"), HttpMethodsType::PUT, RoleController::class, 'update');
...
$deleteRoute = new Route(Urls::transformRouteUrl("/jobRoles/:id"), HttpMethodsType::DELETE, RoleController::class, 'delete');
